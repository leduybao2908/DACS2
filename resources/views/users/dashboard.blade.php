...
<!-- Mirrored from code-theme.com/html/findhouses/{{ route('dashboard') }} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Oct 2024 14:28:17 GMT -->
<head>
    <meta charset="UTF-8">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">User Panel</a>
                                                <ul>
                                                    ...
                                                    <li><a href="{{ route('user') }}">User Profile</a></li>
                                                    <li><a href="{{ route('my-listings') }}">My Properties</a></li>
                                                    <li><a href="{{ route('favorited-listings') }}">Favorited Properties</a></li>
