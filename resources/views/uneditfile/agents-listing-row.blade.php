...
<!-- Mirrored from code-theme.com/html/findhouses/agents-listing-row')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Oct 2024 14:28:04 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="news-item news-item-sm">
                                    <a href="{{url('/agent-details')}}" class="news-img-link">
                                    ...
                                    <div class="news-item-text">
                                        <a href="{{url('/agent-details')}}"><h3>Carls Jhons</h3></a>
                            ...
                            <div class="col-md-12 col-xs-12 space">
                                <div class="news-item news-item-sm">
                                    ...
                                    <div class="news-item-text">
                                        <a href="{{url('/agent-details')}}"><h3>Arling Tracy</h3></a>
                                        <div class="the-agents">
                                            <ul class="the-agents-details">
                                                <li><a href="#">Office: (234) 0200 17813</a></li>
                                                <li><a href="#">Mobile: (657) 9854 12095</a></li>
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="news-item news-item-sm">
                                    ...
                                    <div class="news-item-text">
                                        <a href="{{url('/agent-details')}}"><h3>Mark Web</h3></a>
                                        <div class="the-agents">
                                            <ul class="the-agents-details">
                                                <li><a href="#">Office: (234) 0200 17813</a></li>
                                                <li><a href="#">Mobile: (657) 9854 12095</a></li>
                            ...
                            <div class="col-md-12 col-xs-12 space">
                                <div class="news-item news-item-sm">
                                    ...
                                    <div class="news-item-text">
                                        <a href="{{url('/agent-details')}}"><h3>Katy Grace</h3></a>
                                        <div class="the-agents">
                                            <ul class="the-agents-details">
                                                <li><a href="#">Office: (234) 0200 17813</a></li>
                                                <li><a href="#">Mobile: (657) 9854 12095</a></li>
                            ...
                            <div class="col-md-12 col-xs-12 space2">
                                <div class="news-item news-item-sm">
                                    ...
                                    <div class="news-item-text">
                                        <a href="{{url('/agent-details')}}"><h3>Chris Melo</h3></a>
                                        <div class="the-agents">
                                            <ul class="the-agents-details">
                                                <li><a href="#">Office: (234) 0200 17813</a></li>
                                                <li><a href="#">Mobile: (657) 9854 12095</a></li>
                            ...
                            <div class="col-md-12 col-xs-12 space2">
                                <div class="news-item news-item-sm">
                                    ...
                                    <div class="news-item-text">
                                        <a href="{{url('/agent-details')}}"><h3>Nina Thomas</h3></a>
                                        <div class="the-agents">
                                            <ul class="the-agents-details">
                                                <li><a href="#">Office: (234) 0200 17813</a></li>
                                                <li><a href="#">Mobile: (657) 9854 12095</a></li>
                            ...
                            <div class="col-md-12 col-xs-12 no-pb2 icho">
                                <div class="news-item news-item-sm">
                                    ...
                                    <div class="news-item-text">
                                        <a href="{{url('/agent-details')}}"><h3>Ichiro Lee</h3></a>
                                        <div class="the-agents">
                                            <ul class="the-agents-details">
                                                <li><a href="#">Office: (234) 0200 17813</a></li>
                                                <li><a href="#">Mobile: (657) 9854 12095</a></li>
