...
<!-- Mirrored from code-theme.com/html/findhouses/agent-details')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Oct 2024 14:28:04 GMT -->
<head>
    <meta charset="UTF-8">
                                        ...
                                        <div class="detail-wrapper-body">
                                            <div class="listing-title-bar">
                                                <div class="text-heading text-left">
                                                    <p><a href="{{url('/index')}}">Home </a> &nbsp;/&nbsp; <span>Agent Single</span></p>
                                                </div>
                                                <h3>Carls Jhons</h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item col-lg-6 col-md-6 col-xs-12 landscapes sale">
                                            <div class="project-single">
                                                ...
                                                <div class="homes-content">
                                                    <!-- homes address -->
                                                    <h3><a href="{{url('/single-property-1')}}">Luxury House</a></h3>
