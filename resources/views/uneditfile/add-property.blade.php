...
<!-- Mirrored from code-theme.com/html/findhouses/add-property')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Oct 2024 14:28:17 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="user-profile-box mb-0">
                            ...
                            <div class="detail clearfix">
                                <ul class="mb-0">
                                    ...
                                    <li>
                                        <a href="{{url('/favorited-listings')}}">
                                            <i class="fa fa-heart" aria-hidden="true"></i>Favorited Properties
                                        </a>
                                    </li>
                                    <li>
                                        <a class="active" href="{{url('/add-property')}}">
...
<!-- Mirrored from code-theme.com/html/findhouses/add-property')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Oct 2024 14:28:18 GMT -->
</html>
