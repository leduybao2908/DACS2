...
<!-- Mirrored from code-theme.com/html/findhouses/properties-list-1')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Oct 2024 14:27:59 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="pro-wrapper">
                                ...
                                <div class="cod-pad single detail-wrapper mr-2 mt-0 d-flex justify-content-md-end align-items-center grid">
                                    ...
                                    <div class="sorting-options">
                                        ...
                                        <a href="{{url('/properties-grid-1')}}" class="change-view-btn lde"><i class="fa fa-th-large"></i></a>
                                    </div>
                                </div>
                            </div>
                        </section>
